...
context('Actions', () => {
  ...
  it('ensure board wrapping', () => {
    cy.get(cell(47, 47)).click()
    cy.get(cell(48, 48)).click()
    cy.get(cell(46, 49)).click()
    cy.get(cell(47, 49)).click()
    cy.get(cell(48, 49)).click()
    ...
    cy.get(cell(2, 2)).should('have.attr', 'data-alive', 'true')
    cy.get(cell(0, 3)).should('have.attr', 'data-alive', 'true')
    cy.get(cell(2, 3)).should('have.attr', 'data-alive', 'true')
    cy.get(cell(1, 4)).should('have.attr', 'data-alive', 'true')
    cy.get(cell(2, 4)).should('have.attr', 'data-alive', 'true')
  })
